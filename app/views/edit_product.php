    ...
    <div class="container">
        ...
        <div class="form-container">
            <?php if (!empty($product)): ?>
                ...
                ?>
                <form method="POST" action="<?php echo base_url('products/update/' . $id); ?>">
                    ...
                    <div class="product-id">Product ID: <?php echo htmlspecialchars($id); ?></div>
            ...
            <?php else: ?>
                <div style="text-align: center; color: #666;">
                    ...
                    <a href="<?php echo base_url('products'); ?>" class="btn cancel-btn" style="margin-top: 20px;">Back to Products</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
